package com.walmartlabs.ern.qrvisadominiapp;

import com.walmartlabs.ern.container.miniapps.QrvisadoMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = QrvisadoMiniappActivity.class;
